...
/* package Simulador-0.1.0.0 */
#ifndef VERSION_Simulador
#define VERSION_Simulador "0.1.0.0"
#endif /* VERSION_Simulador */
#ifndef MIN_VERSION_Simulador
#define MIN_VERSION_Simulador(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Simulador */
...
#define CURRENT_COMPONENT_ID "Simulador-0.1.0.0-6uBmKScFMfmJIy2VJlY5Qv-Simulador"
